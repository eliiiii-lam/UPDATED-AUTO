...
@Autonomous (name = "RED LONG PIXEL B")
public class redlongpixelB extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        strafe(DRIVE_SPEED, -25, 25, -25, 25, 1.5);
        encoderDrive(DRIVE_SPEED, -30, -30,1.5);
        encoderDrive(DRIVE_SPEED, -arc90, arc90, 1.5);
        encoderDrive (DRIVE_SPEED, 80, 80, 1.5);
        strafe(DRIVE_SPEED, -28, 28, -28, 28, 1.5);
